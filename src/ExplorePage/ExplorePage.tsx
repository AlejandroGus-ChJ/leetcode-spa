...
export const ExplorePage: React.FC<{ mockDataForStorybook?: any }> = ({ mockDataForStorybook }) => {
    ...
    if (isLoading) {
        return (
            <S.PageContainer>
                <Box><Skeleton variant="text" width="30%" height={60} /><Skeleton variant="text" width="50%" /></Box>
                ...
                <Box><Skeleton variant="rounded" height={40} width="100%" /></Box>
                <Grid container spacing={3}>
                    {[1, 2, 3].map((n) => (
    ...
    return (
        <S.PageContainer>
            ...
            <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 4 }}>
                    <S.KpiCard variant="outlined">
                        ...
                        <Box>
                            <Typography variant="h5" fontWeight="bold">{stats.topicsAvailable}</Typography>
                            <Typography variant="body2" color="text.secondary">Topics Available</Typography>
                        </Box>
                    </S.KpiCard>
                </Grid>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                    <S.KpiCard variant="outlined">
                        ...
                        <Box>
                            <Typography variant="h5" fontWeight="bold">{stats.problemsSolved}</Typography>
                    ...
                    <S.KpiCard variant="outlined">
                        <Box sx={{ width: '100%' }}>
                            <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 1 }}>
                                ...
                                <Box>
                                    <Typography variant="h5" fontWeight="bold">{stats.overallProgress}%</Typography>
                                    <Typography variant="body2" color="text.secondary">Overall Progress</Typography>
                                </Box>
                            </Stack>
                            <LinearProgress variant="determinate" value={stats.overallProgress} color="primary" sx={{ borderRadius: 2, height: 6 }} />
                        </Box>
                    </S.KpiCard>
                </Grid>
            </Grid>
            ...
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
                <Box>
                    <Typography variant="subtitle2" gutterBottom fontWeight="bold">Categoría</Typography>
                    <ToggleButtonGroup
                ...
                <Box>
                    <Typography variant="subtitle2" gutterBottom fontWeight="bold">Dificultad</Typography>
                    <ToggleButtonGroup
            ...
            {filteredTopics.length === 0 ? (
                <Box sx={{ py: 8, textAlign: 'center' }}>
                    <Typography variant="h6" color="text.secondary">No topics match current filters</Typography>
                </Box>
            ) : (
                <Grid container spacing={3}>
                                    ...
                                    <Box>
                                        <Box sx={{ mb: 2 }}>
                                            <Stack direction="row" justifyContent="space-between" sx={{ mb: 0.5 }}>
                                                ...
                                                <Typography variant="caption" fontWeight="bold">{topic.problemsSolved}/{topic.totalProblems}</Typography>
                                            </Stack>
                                            <LinearProgress
                                                variant="determinate"
                                                value={progressVal}
